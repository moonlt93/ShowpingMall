...
<aside id="aside">
 ...
 <li>
  ...
  <div class="delBtn">
  	 <button type="button" id="SelDel_btn" class="selectDelete_btn">선택 삭제</button> 
  <script>
 ...
 <li>
  <div class="checkBox">
   <input type="hidden" name="chBox" class="chBox" data-cartNum="${cartList.cartNum}" />
...
<div class="orderOpen">
	<button type="button" class="orderOpen_btn">주문 정보입력</button>
</div>
...
<div class="orderInfo">
 <form role="form" method="post" autocomplete="off">
  ...
  <div class="inputArea">
   ...
   <p>
   <input type="text" id="userAddr1" id="sample2_address" placeholder="주소">
   <input type="text" id="userAddr2" id="sample2_detailAddress" placeholder="상세주소">
   <input type="text" id="userAddr3" id="sample2_extraAddress" placeholder="참고">
   </p>
